...
static void _test_print_element_to_file_stdout()
{
    Element element;
    char const *input = "123";
    bool is_success = parse_element(&element, &input);
    if (is_success)
    {
        printf_color(GREEN, "_test_print_element_to_file_stdout: %s\n", is_success ? "true" : "false");
    }
    else
    {
        printf_color(RED, "_test_print_element_to_file_stdout: %s\n", is_success ? "true" : "false");
    }
...
static void _test_print_element_to_file_seperate_txt_file()
{
    Element element;
    char const *input = "123";
    bool is_success = parse_element(&element, &input);
    if (is_success)
    {
        printf_color(GREEN, "_test_print_element_to_file_seperate_txt_file: %s\n", is_success ? "true" : "false");
    }
    else
    {
        printf_color(RED, "_test_print_element_to_file_seperate_txt_file: %s\n", is_success ? "true" : "false");
    }
...
int main(int argc, char *argv[])
{
    ...
    _test_print_element_to_file_stdout();
    _test_print_element_to_file_seperate_txt_file();
